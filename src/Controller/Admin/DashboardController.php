...
//        return parent::index();
        $routeBuilder = $this->container->get(AdminUrlGenerator::class);
                $url = $routeBuilder->setController(DestinationCrudController::class)->generateUrl();
...
//        yield MenuItem::linkToDashboard('Dashboard', 'fa fa-home');
                ...
                yield MenuItem::linkToCrud('Destination', 'fas fa-comments', Destination::class);
